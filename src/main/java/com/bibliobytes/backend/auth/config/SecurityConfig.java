    ...
    public SecurityFilterChain securityfilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(c -> c
                ...
                .requestMatchers(HttpMethod.POST, "me/validate/oldemail/code").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                .requestMatchers(HttpMethod.POST, "me/validate/newemail/code").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                ...
                .requestMatchers(HttpMethod.GET, "/items/actors").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                .requestMatchers(HttpMethod.GET, "/items/languages").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                .requestMatchers(HttpMethod.GET, "/items/subtitles").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
