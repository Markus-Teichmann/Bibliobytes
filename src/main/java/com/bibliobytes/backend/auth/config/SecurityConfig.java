    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(c -> c
                ...
                .requestMatchers(HttpMethod.PUT,"/users/updateCredentials").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                .requestMatchers(HttpMethod.PUT,"/users/updateCredentials/confirm").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
                .requestMatchers(HttpMethod.PUT,"/users/updateProfile").hasAnyRole(Role.USER.name(), Role.SERVICE.name(), Role.ADMIN.name())
